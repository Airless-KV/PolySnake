...
public class MainGameModeController : MonoBehaviour
{
    public static MainGameModeController Instance;
    ...
    void Start()
    {
        currentMode = MainGameBootManager.CurrentGameMode;
        timeLeft = MainGameBootManager.TimeLimit;
